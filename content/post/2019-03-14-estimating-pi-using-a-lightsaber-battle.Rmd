...
knitr::include_graphics("animals-with-lightsabers-11.png")
```
...
```{r, echo=FALSE, fig.cap="Represent our lightsabor as a line with no width. A single beam of light."}
par(mar=c(0,0,0,0))
...
```{r, echo=FALSE, fig.cap="Me and the team preparing for our transects.", out.width = '100%'}
knitr::include_graphics("wp2848056.png")
```
