...
### Today is 3-14, and those numbers are the first three digits of Pi. To celebrate, I estimated Pi using a lightsaber battle. I first build an army of saber-wielding critters in La Fountaine park, then I cut 6 transects across the battlefield and count the number of contacts I make with critter-sabers along the way. After the battle, I take a ratio of hits vs. misses to estimate Pi.
